* TODO get a minimal version of the app running
  - [-] sequentially picking lifepaths
    - [X] write lifepath decoders for api module
    - [X] think about how to do the interface
      - drag and drop? how?
    - [ ] get dnd working; able to drop first lifepath of a new block
      - [ ] limit the dragging to just the 'handle'?
      - [ ] make dropping work correctly, not stick on click

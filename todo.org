* DONE add a Creation.Workbench module that wraps the array
...
* TODO get a minimal version of the app running [0/6]
  ...
  - [ ] think about a 'suggestions' endpoint
        ...
        should display the setting name of a lifepath
